...
const ChickenSwing = ({ rotation }) => {
  const classes = useStyles(rotation);
  return (
    <svg className="svg" viewBox="0 0 346 512" version="1.1" role="img">
      <title>Chicken Swing</title>
      <desc>A chicken swinging gently on a swing</desc>
      <g id="swinging" className={classes.swinging}>
        <path
          id="body"
          className="chicken"
